...
const Cloud = ({
    ...
    ...props}) => {
        ...
        const handlePointerMove = (e) => {
            ...
            if (isRotating) {
                ...
                cloudRef.current.rotation.y += delta * 0.01 * Math.PI;
        ...
        const handleKeyDown = (e) => {
            if (e.key === 'ArrowLeft') {
                ...
                cloudRef.current.rotation.y += 0.01 * Math.PI;
        ...
        useFrame(() => {
            if (!isRotating) {
                ...
                const rotation = cloudRef.current.rotation.y;
            ...
            // Set the current stage based on the island's orientation
                switch (true) {
                    case normalizedRotation >= 5.45 && normalizedRotation <= 6:
                        setCurrentStage(4);
                        break;
                    case normalizedRotation >= 0 && normalizedRotation < 2.4:
                        setCurrentStage(3);
                        break;
                    case normalizedRotation >= 2.4 && normalizedRotation < 4.25:
                        setCurrentStage(2);
                        break;
                    case normalizedRotation >= 4.25 && normalizedRotation < 5.45:
                        setCurrentStage(1);
                        break;
                    default:
  ...
  return (
    <a.group ref={cloudRef} {...props} dispose={null}>
